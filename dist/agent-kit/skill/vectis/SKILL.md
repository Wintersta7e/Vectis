---
name: vectis
description: Generate a structured digest map of a codebase (symbols, dependency graph, architecture label, hotspots) using the vectis CLI, for agent orientation or context injection.
---

# Vectis — codebase digest tool for agents
